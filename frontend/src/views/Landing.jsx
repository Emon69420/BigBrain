      ...
      <div style={{position:"relative", zIndex:2, maxWidth:1280, margin:"0 auto", padding:"28px 28px 24px", display:"grid", gridTemplateColumns:"1.05fr 1.35fr", gap:24, alignItems:"center"}}>
        ...
        <div>
          ...
          <div style={{display:"flex", gap:10, marginTop:6}}>
            <button onClick={onEnter} style={{background:"transparent", color:"#fff", border:"1px solid #fff", borderRadius:8, padding:"10px 18px", fontWeight:700, fontSize:13, cursor:"pointer", boxShadow:"none", display:"flex", alignItems:"center", gap:6}}>Get Started <span>→</span></button>
            <button onClick={onEnter} style={{background:"transparent", color:"#fff", border:"1px solid #fff", borderRadius:8, padding:"10px 18px", fontWeight:600, fontSize:13, cursor:"pointer"}}>Learn More</button>
          </div>
          <div style={{display:"flex", gap:18, marginTop:22, flexWrap:"wrap"}}>
            <div style={{display:"flex", gap:8, alignItems:"center"}}>
              <span style={{width:28,height:28,borderRadius:8,background:"rgba(255,255,255,.06)",border:"1px solid rgba(255,255,255,.08)",display:"grid",placeItems:"center",fontSize:11,fontWeight:700,color:"#A5B4FC",fontFamily:"var(--mono)"}}>01</span>
            ...
            <div style={{display:"flex", gap:8, alignItems:"center"}}>
              <span style={{width:28,height:28,borderRadius:8,background:"rgba(255,255,255,.06)",border:"1px solid rgba(255,255,255,.08)",display:"grid",placeItems:"center",fontSize:11,fontWeight:700,color:"#A5B4FC",fontFamily:"var(--mono)"}}>02</span>
            ...
            <div style={{display:"flex", gap:8, alignItems:"center"}}>
              <span style={{width:28,height:28,borderRadius:8,background:"rgba(255,255,255,.06)",border:"1px solid rgba(255,255,255,.08)",display:"grid",placeItems:"center",fontSize:11,fontWeight:700,color:"#A5B4FC",fontFamily:"var(--mono)"}}>03</span>
      ...
      <div style={{position:"relative", zIndex:2, maxWidth:1280, margin:"8px auto 0", padding:"14px 28px", borderTop:"1px solid rgba(255,255,255,.06)", display:"flex", flexDirection:"column", gap:12}}>
        ...
        <div style={{display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:16, padding:"6px 0"}}>
          <div style={{display:"flex", gap:10, alignItems:"center"}}>
            <span style={{width:34,height:34,borderRadius:8,background:"rgba(255,255,255,.06)",display:"grid",placeItems:"center",fontSize:11,fontWeight:700,color:"#A5B4FC",fontFamily:"var(--mono)",border:"1px solid rgba(255,255,255,.08)"}}>01</span>
          ...
          <div style={{display:"flex", gap:10, alignItems:"center", borderLeft:"1px solid rgba(255,255,255,.06)", paddingLeft:16}}>
            <span style={{width:34,height:34,borderRadius:8,background:"rgba(255,255,255,.06)",display:"grid",placeItems:"center",fontSize:11,fontWeight:700,color:"#A5B4FC",fontFamily:"var(--mono)",border:"1px solid rgba(255,255,255,.08)"}}>02</span>
          ...
          <div style={{display:"flex", gap:10, alignItems:"center", borderLeft:"1px solid rgba(255,255,255,.06)", paddingLeft:16}}>
            <span style={{width:34,height:34,borderRadius:8,background:"rgba(255,255,255,.06)",display:"grid",placeItems:"center",fontSize:11,fontWeight:700,color:"#A5B4FC",fontFamily:"var(--mono)",border:"1px solid rgba(255,255,255,.08)"}}>03</span>
          ...
          <div style={{display:"flex", gap:10, alignItems:"center", borderLeft:"1px solid rgba(255,255,255,.06)", paddingLeft:16}}>
            <span style={{width:34,height:34,borderRadius:8,background:"rgba(255,255,255,.06)",display:"grid",placeItems:"center",fontSize:11,fontWeight:700,color:"#A5B4FC",fontFamily:"var(--mono)",border:"1px solid rgba(255,255,255,.08)"}}>04</span>
