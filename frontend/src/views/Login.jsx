  ...
  return (
    <div className="login-page">
      ...
      <div className="login-card">
        <div style={{display:"flex", justifyContent:"center", color:"var(--ink-dark)"}}><BrainMark size={36}/></div>
        <h1 style={{textAlign:"center"}}>Sovereign Industrial AI Workbench</h1>
        <p className="muted" style={{textAlign:"center", margin:"8px 0 20px", fontSize:13, color:"#6B7280"}}>Your documents. Your GPU. No exit.</p>
